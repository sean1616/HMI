...
{
    public class Elem_A6_1 : FrameworkElement
    {      
        public static readonly DependencyProperty MinimumProperty =
          DependencyProperty.Register("Minimum", typeof(double), typeof(Elem_A6_1),
        ...
        public static readonly DependencyProperty MaximumProperty =
           DependencyProperty.Register("Maximum", typeof(double), typeof(Elem_A6_1),
        ...
        public static readonly DependencyProperty TickUnitLongProperty =
            DependencyProperty.Register("TickUnitLong", typeof(double), typeof(Elem_A6_1),
        ...
        public static readonly DependencyProperty MinimumPositionProperty =
            DependencyProperty.Register("MinimumPosition", typeof(double), typeof(Elem_A6_1),
            new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsRender));
        ...
        public static readonly DependencyProperty MaximumPositionProperty =
            DependencyProperty.Register("MaximumPosition", typeof(double), typeof(Elem_A6_1),
        ...
        public static readonly DependencyProperty ThresholdOneProperty =
            DependencyProperty.Register("ThresholdOne", typeof(double), typeof(Elem_A6_1),
    ...
    DependencyProperty.Register("ThresholdTwo", typeof(double), typeof(Elem_A6_1),
   ...
   DependencyProperty.Register("CurrentValue", typeof(double), typeof(Elem_A6_1),
   new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsRender));
  ...
  DependencyProperty.Register("TargetValue", typeof(double), typeof(Elem_A6_1),
  ...
  DependencyProperty.Register("LimitValue", typeof(double), typeof(Elem_A6_1),
  new FrameworkPropertyMetadata(520.0, FrameworkPropertyMetadataOptions.AffectsRender));
        ...
        public static readonly DependencyProperty ScaleFormatProperty =
           DependencyProperty.Register("ScaleFormat", typeof(string), typeof(Elem_A6_1),
        ...
        public static readonly DependencyProperty UnitFormatProperty =
          DependencyProperty.Register("UnitFormat", typeof(string), typeof(Elem_A6_1),
        ...
        protected override void OnRender(System.Windows.Media.DrawingContext drawingContext)
        {
            ...
            //var NowState = new FormattedText("目前:" + Math.Round(CurrentValue, 0).ToString(ScaleFormat),
            //        CultureInfo.CurrentCulture, System.Windows.FlowDirection.LeftToRight,
            //        new Typeface("Arial"), 15, Brushes.White);
            ...
            var TargetState = new FormattedText("目標值:" + Math.Round(TargetValue, 0).ToString(ScaleFormat),
                    CultureInfo.CurrentCulture, System.Windows.FlowDirection.LeftToRight,
