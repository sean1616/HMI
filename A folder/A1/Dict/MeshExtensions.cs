...
namespace HMI_PermanentForm
{
    public static class MeshExtensions
    {
        ...
        // Add a segment representing the triangle's normal to the normals mesh. //將代表三角向量的片段加入normals mesh
        private static void AddTriangleNormal(MeshGeometry3D mesh, MeshGeometry3D normals, Point3D point1, Point3D point2, Point3D point3, double length, double thickness)
        {
        ...
        // Calculate a triangle's normal vector. //計算三角向量
        ...
        // Return a MeshGeometry3D representing this mesh's wireframe. 回傳網格外框
        ...
        public static MeshGeometry3D XAxisArrow(float length)
        {
            ...
            mesh.AddArrow(new Point3D(0, 0, 0), new Point3D(6, 0, 0), new Vector3D(0, 1, 0), 0.5);
            return mesh;
        }
